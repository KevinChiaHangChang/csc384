    ...
    while not frontier.isEmpty():
        ...
        for each_node, each_action, each_cost in successors:
            ...
            if each_node not in path:
                ...
                frontier.push((new_path,new_action,new_cost))
    #Return no action, if goal state was not found
    return no_action
